...
<?php 
    $url = home_url('my-reservation'); 
    $url = add_query_arg('house',$post->ID, $url);
...
<div id="post-<?php the_ID(); ?>" class="bl-row-one">
    ...
    <div class="bl-column-two">
        ...
        <p><?php the_excerpt(); ?></p>
           <div><a href="<?php echo $url; ?>"><img src="<?php echo get_template_directory_uri(); ?>/images/confirm-btn.png" alt="" /></a></div>
    </div>
</div>
